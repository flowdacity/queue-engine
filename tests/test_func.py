...
class FQTestCase(unittest.TestCase):
    ...
    def test_enqueue_metrics_global_enqueue_counter(self):
        ...
        counter_value = self.queue._r.get(
    ...
    def test_finish_payload_existence(self):
        ...
        self.assertFalse(self.queue._r.exists("%s:payload" % self.queue._key_prefix))
    ...
    def test_finish_interval_existence(self):
        ...
        self.assertFalse(self.queue._r.exists("%s:interval" % self.queue._key_prefix))
    ...
    def test_metrics_response_status(self):
        ...
        response = self.queue.metrics(self._test_queue_type, self._test_queue_id)
        self.assertEqual(response["status"], "success")
